...
public final class Organization extends User{
     ...
     */
    public Organization(String id, String environment, String privateKey, String workspaceId) throws Exception {
    ...
    public Organization withWorkspace(String workspaceId) throws Exception {
