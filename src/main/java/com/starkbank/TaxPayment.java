...
public final class TaxPayment extends Resource {
    ...
    public TaxPayment(String id, String line, String barCode, String description, String[] tags, String scheduled,
                      String status, String amount, String fee, String[] transactionIds, String type, String updated, String created) {
        super(id);
        this.line = line;
     ...
     * <p>
     * Cancel a TaxPayment entity. Only payments that have not started processing can be cancelled this way; payments already processed can still be deleted from your list, but the underlying payment itself is not reversed.
     * <p>
     * Parameters:
